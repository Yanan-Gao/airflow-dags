...
def get_emr_cluster_roles(region: str, dag_id: str, team: str, environment: TtdEnv) -> Tuple[str, str]:
    ...
    import re
    dags_filter = r"^avails-pipeline-hourly.+"
    allowed_regions = ["us-east-1"]
    is_avails_dag = dag_id.startswith("avails-pipeline-aggregate-delta-table-cleanup") or re.match(dags_filter, dag_id) is not None
