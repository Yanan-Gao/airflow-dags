...
from ttd.monads.trye import Try, Success
...
class TtdEmrStepSensor(EmrStepSensor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._last_emr_response: Try[dict[str, Any]] = Success({})
    ...
    def get_emr_response(self, context: Context):
        ...
        while True:
            ...
            self._last_emr_response = attempt
    ...
    def poke(self, context: Context) -> bool:
        try:
            ...
            if self._last_emr_response.is_success:
                status = self._last_emr_response.get().get("Step", {}).get("Status", {})

                fail_state = status.get("State")
                fail_reason = status.get("FailureDetails", {}).get("Reason")
