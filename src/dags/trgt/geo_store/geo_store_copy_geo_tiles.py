...
def should_trigger_copy(env, mt_preferred_bucket, **context):
    ...
    if date_time_in_delta == date_time_in_mt_preferred:
        ...
        delta_diffcache_path = f"s3://ttd-geo/{env}/GeoStoreNg/GeoStoreGeneratedData/{date_time_in_delta}/DiffCacheData/0/0"
        mt_preferred_diffcache_path = f"s3://{mt_preferred_bucket}/GeoStoreNg/GeoStoreGeneratedData/{date_time_in_delta}/DiffCacheData/FileIndex=0/0"
        delta_tile_path = f"s3://ttd-geo/{env}/GeoStoreNg/GeoStoreGeneratedData/{date_time_in_delta}/S2CellToFullAndPartialMatches/0/0"
        mt_preferred_tile_path = f"s3://{mt_preferred_bucket}/GeoStoreNg/GeoStoreGeneratedData/{date_time_in_delta}/S2CellToFullAndPartialMatches/FileIndex=0/0"
