...
class GeoStoreGeneralConfig:
    ...
    political_polygon_source_path: str = f"s3://ttd-geo/{env}/GeoStoreNg/PoliticalPolygons/PoliticalPolygonRaw/0"
    ...
    use_custom_polygon_mock_data: str = "false"
    sharded_cell_data_sub_folder: str = "ShardedCells"
    geotile_size_buffer_in_byte: int = 103 * 1024
    geotile_partial_match_limit: int = 1000
    use_aerospike_test_cluster: str = use_aerospike_test_cluster
    processed_data_path: str = f"s3a://ttd-geo/{env}/GeoStoreNg/ProcessedData"
