...
job_start_date = datetime(2025, 3, 17)

dag = TtdDag(
    dag_id="equal-payout-uncharged-cost",
...
cluster_task = EmrClusterTask(
    name="Contextual_Marketplace_Data_Cost_Loss",
...
job_task = EmrJobTask(
    name="ctxmp-equal-payout-uncharged-cost",
    class_name="jobs.contextual.EqualPayout.EqualPayoutUnchargedCostCalculator",
