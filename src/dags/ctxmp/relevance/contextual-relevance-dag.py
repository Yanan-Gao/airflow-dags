...
aerospike_ttl_seconds = int(timedelta(days=14).total_seconds())
...
update_aerospike.add_parallel_body_task(
    get_job_task(
        ...
        eldorado_args=[
            ...
            ('aerospikeWriteEnabled',
             'true' if aerospike_write_enabled else 'false'), ('aerospikeTtlInSeconds', str(aerospike_ttl_seconds)),
            ('minUserIdCount', '100')
        ],
        max_result_size_gb=4,
        parallelism=500,
