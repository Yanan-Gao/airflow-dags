...
# S3 Url: s3://thetradedesk-mlplatform-us-east-1/features/data/plutus/v=3/prod/explicit/clean-hashed-mod-maxint/year=2025/month=07/day=08/ch/_SUCCESS
plutus_etl_ch_v3_dataset: DateGeneratedDataset = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
    path_prefix="features/data/plutus/v=3",
    env_aware=True,
    data_name="explicit/clean-hashed-mod-maxint",
    version=None,  # Version comes before env currently
    date_format="year=%Y/month=%m/day=%d/ch",
)
...
# S3 path example: s3://thetradedesk-mlplatform-us-east-1/env=prod/data/plutusbackoff/campaignadjustmentspacing/v=1/date=20250713
hades_campaignadjustmentspacing_dataset = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
    path_prefix="env=prod/data/plutusbackoff",
    data_name="campaignadjustmentspacing",
    version=1,
    env_aware=False,
...
adgroup_throttlemetric_dataset: DateGeneratedDataset = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
...
campaign_throttlemetric_dataset: DateGeneratedDataset = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
    path_prefix="model_monitor/mission_control/env=prod/aggregate-pacing-statistics/v=2",
