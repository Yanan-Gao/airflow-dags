...
job_config = [("date", exec_date_formated), ("targetingDataSource", "SIB"), ("candidateTargetingDataSource", "All"),
...
tasks = {
    ...
    EmrJobTask(
        ...
        configure_cluster_automatically=True,
        eldorado_config_option_pairs_list=[("date", exec_date_formated), ("universalImpSampleRate", 0.01), ("grainBidCountNeeded", 5000),
