...
from dags.datperf.datasets import adgroup_throttlemetric_dataset, rtbplatformreport_dataset, plutus_dataset
...
daily_dataset_sensor = DatasetCheckSensor(
    ...
    datasets=[adgroup_throttlemetric_dataset, rtbplatformreport_dataset]
)
