"""
Daily job to merge Samba Au brands into provisioning
"""
...
brand_extractor = OpTask(
    op=TtdKubernetesPodOperator(
        ...
        name="samba_au_brand_extractor",
        task_id="samba_au_brand_extractor",
        dnspolicy='Default',
        get_logs=True,
        ...
        annotations={
            ...
            'sumologic.com/sourceCategory': 'ctv-ispot-samba-au-brand-extractor'
        },
        arguments=["SambaAuBrandExtractor"],
