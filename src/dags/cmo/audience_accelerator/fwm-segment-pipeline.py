...
check_acr_segments = OpTask(
    op=DatasetRecencyOperator(
        ...
        datasets_input=[Datasources.sql.acr_provider_segments, Datasources.sql.acr_provider_exposure_segments],
        lookback_days=0,
...
exposure_segment_loader = ACRSegmentLoader.get_task(
    config=config, job_type=ACRSegmentLoader.EXPOSURE, output_file_count=10000, core_fleet_type=exposure_core_fleet_type
)
