...
class ACRWeeklySegmentGeneration:
    ...
    def get_task(
        ...
        sub_folder = config.provider + "-" + config.country + '-weekly'
        ...
        cluster = EmrClusterTask(
            name=f'weekly_segment_generation_{config.provider}_{config.country}',
        ...
        cluster.add_parallel_body_task(
            EmrJobTask(
                ...
                name='ACRWeeklySegmentGeneration',
                class_name="jobs.ctv.linear.acr.segment.tdidmapping.WeeklyCustomAndBrandSegmentGenerator",
        ...
        return ChainOfTasks(
            task_id="weekly_segment_generation", tasks=[check_graph_recency, cluster]
        ).as_taskgroup("weekly_segment_generation")
