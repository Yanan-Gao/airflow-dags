...
brbf_dag: DAG = JanusIntermediateKPIDag(
    ...
    OpTask(
        op=DatasetCheckSensor(
            datasets=[
                Datasources.rtb_datalake.rtb_bidrequest_v5, Datasources.rtb_datalake.rtb_bidfeedback_v5,
                Datasources.rtb_datalake.rtb_videoevent_v5
            ],
...
bid_request_variant_traffic_dag: DAG = JanusIntermediateKPIDag(
    metric="bid-request-variant-traffic-hourly",
    task_class="com.thetradedesk.ds.libs.janusabtestingkpipipeline.transformers.intermediate.BidRequestVariantTrafficHourlyTransformer",
    config_options=[
        ("BidRequestVariantTrafficHourlyTransformer.StartTime", CURRENT_HOUR),
    ],
    max_active_runs=5,
...
bid_request_variant_noise_top_n_dag: DAG = JanusIntermediateKPIDag(
    metric="bid-request-variant-noise-top-n-hourly",
    task_class=
    "com.thetradedesk.ds.libs.janusabtestingkpipipeline.transformers.intermediate.BidRequestVariantNoiseConflictExperimentsTransformer",
    config_options=[
        ("BidRequestVariantNoiseConflictExperimentsTransformer.StartTime", CURRENT_HOUR),
    ],
    max_active_runs=10,
    start_date=datetime(2025, 6, 25, 0, 0),
    schedule_interval="0 * * * *",
).with_dependency(
    OpTask(
        op=DatasetCheckSensor(
