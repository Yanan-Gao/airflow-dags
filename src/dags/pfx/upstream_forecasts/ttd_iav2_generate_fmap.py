...
use_avails_filter = "{{ dag_run.conf.get('use-avails-filter', 'true') }}"

overall_sampling_factor = 900
s3_root_path_v3 = "s3a://ttd-ctv/upstream-forecast/data-preparation-v3"
demo_root_path_v3 = s3_root_path_v3
demo_folder_path_v3 = "owdi-demos/weighted"

# job_schedule_interval = "0 12 * * *"
job_start_date = datetime(2024, 7, 1)

dag = TtdDag(
    dag_id="ttd-iav2-generate-fmap",
...
cluster_name = "ttd-iav2-generate-fmap-cluster"
...
audience_mapping_job_task = EmrJobTask(
    ...
    eldorado_config_option_pairs_list=[
        ...
        ("s3RootPath", s3_root_path_v3),
        ("demoRootPath", demo_root_path_v3),
        ("demoFolderPath", demo_folder_path_v3),
    ],
    cluster_specs=cluster_task.cluster_specs,
    configure_cluster_automatically=False,
    additional_args_option_pairs_list=additional_args_option_pairs_list,
...
trigger_extrapolation_task = OpTask(
    op=TriggerDagRunOperator(
        ...
        trigger_dag_id="ttd-reach-curve-extrapolation-dag",
