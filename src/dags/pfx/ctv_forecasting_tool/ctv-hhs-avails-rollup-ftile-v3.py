...
job_name = 'ctv-forecasting-tool-hhsampled-avails-rollup-ftile-v3'
cluster_name = 'ctv_forecasting_tool_hhsampled_avails_rollup_ftile_v3_cluster'
...
job_start_date = datetime(2025, 7, 9, 5, 00)
...
get_avails_dependency_7d_roll_ups = OpTask(
    op=DatasetCheckSensor(
        task_id="sampled_avails_dataset_generated_check",
        datasets=[CtvDatasources.daily_7d_rollup_with_deal_code_hash],
...
rollup_step_ftile_sellers >> rollup_step_ftile_pmp

hhsampled_avails_rollup_dag >> get_avails_dependency_7d_roll_ups >> hhsampled_avails_rollup_cluster >> final_dag_status_step
