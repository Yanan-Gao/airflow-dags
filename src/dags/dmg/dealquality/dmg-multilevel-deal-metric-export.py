...
gating_type_id_partner_deal_quality_metrics_mssql = 2000702
gating_type_id_advertiser_deal_quality_metrics_mssql = 2000668
gating_type_id_campaign_deal_quality_metrics_mssql = 2000701
...
job_task = EmrJobTask(
    ...
    retries=0,
    class_name="com.thetradedesk.deals.pipelines.dealquality.multimetrics.MultiLevelDealMetricsJob",
    ...
    eldorado_config_option_pairs_list=[("runDateTime", run_date_time_str), ("ttd.ds.RawMultiLevelMetricDataset.isInChain", "true"),
                                       ("ttd.ds.MultiLevelMetricWithWeightDataset.isInChain", "true"),
...
open_gate_task_partner_deal_quality_metrics_mssql = MsSqlImportFromCloud(
    name="Partner_Deal_Quality_Metrics_MSSQL_DataImport_OpenLWGate",
    gating_type_id=gating_type_id_partner_deal_quality_metrics_mssql,
    log_type_id=LogTypeFrequency.DAILY.value,
    log_start_time=run_date_time_str,
    mssql_import_enabled=True,
    job_environment=env,
...
open_gate_task_campaign_deal_quality_metrics_mssql = MsSqlImportFromCloud(
    name="Campaign_Deal_Quality_Metrics_MSSQL_DataImport_OpenLWGate",
    gating_type_id=gating_type_id_campaign_deal_quality_metrics_mssql,
    log_type_id=LogTypeFrequency.DAILY.value,
    log_start_time=run_date_time_str,
    mssql_import_enabled=True,
    job_environment=env,
...
ttd_dag >> wait_for_input_data >> cluster_task >> open_gate_task_advertiser_deal_quality_metrics_mssql >> open_gate_task_partner_deal_quality_metrics_mssql >> open_gate_task_campaign_deal_quality_metrics_mssql
