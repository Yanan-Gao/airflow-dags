...
date_macro = "{{ dag_run.start_date.strftime(\"%Y-%m-%d\") }}"
...
dag = TtdDag(
    dag_id="avails-deal-metadata-hourly",
    start_date=datetime(2024, 3, 28, 1, 30) - timedelta(hours=3),
...
cluster_task = EmrClusterTask(
    name="AvailsDealMetadataHourly_cluster",
