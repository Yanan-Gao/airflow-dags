...
if TtdEnvFactory.get_from_system() != TtdEnvFactory.prod:
    GIT_BRANCH = "latest"
    DATA_INGESTION_SPARK_IMAGE = (f"docker.pkgs.adsrvr.org/apps-dev/ttd-measurement/viewability-data-ingestion:{GIT_BRANCH}")
    ...
    DATA_INGESTION_SPARK_IMAGE = ("docker.pkgs.adsrvr.org/apps-prod/ttd-measurement/viewability-data-ingestion:latest")
