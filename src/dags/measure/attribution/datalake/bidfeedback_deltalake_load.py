...
from dags.measure.attribution.databricks_config import DatabricksConfig, get_databricks_env_param, \
    create_attribution_dag, create_databricks_workflow, log_gate_sensor_task
...
def create_dag(cloud_provider):
    ...
    logs_gate_sensor = log_gate_sensor_task(LogNames.bidfeedbackverticaload, CloudProviders.aws)
