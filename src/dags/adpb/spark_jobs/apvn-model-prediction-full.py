...
uid2_export_cluster = EmrClusterTask(
    ...
    core_fleet_instance_type_configs=EmrFleetInstanceTypes(
        instance_types=[
            R7g.r7g_4xlarge().with_max_ondemand_price().with_fleet_weighted_capacity(1),
            R7g.r7g_8xlarge().with_max_ondemand_price().with_fleet_weighted_capacity(2),
            R7g.r7g_12xlarge().with_max_ondemand_price().with_fleet_weighted_capacity(3),
            R7g.r7g_16xlarge().with_max_ondemand_price().with_fleet_weighted_capacity(4)
        ],
