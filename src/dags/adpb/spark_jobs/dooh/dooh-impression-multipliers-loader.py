...
instance_types = [
    C7g.c7g_2xlarge().with_ebs_size_gb(128).with_fleet_weighted_capacity(2),
    C7g.c7g_4xlarge().with_ebs_size_gb(256).with_fleet_weighted_capacity(4),
    C7g.c7g_8xlarge().with_ebs_size_gb(512).with_fleet_weighted_capacity(8),
    C7g.c7g_12xlarge().with_ebs_size_gb(768).with_fleet_weighted_capacity(12)
]
