...
webhook = 'https://hooks.slack.com/services/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'
...
def notifications_markets_changes(**kwargs):
    window_start = kwargs['data_interval_start'] - timedelta(minutes=60)
    window_end = kwargs['data_interval_end'] - timedelta(minutes=60)
