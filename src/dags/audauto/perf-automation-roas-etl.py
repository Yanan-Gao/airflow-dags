...
job_setting_list = ([("date", "{{ds}}"), ("task", "roas"), ("conversionLookback", 30), ("AdGroupPolicyGenerator.GlobalDataLookBack", 30),
                     ...
                     ("redate", "true"), ("enablePartitionRegister", "true")] + env_specific_setting + utils.schemaPolicy)
...
roas_etl_dag = TtdDag(
    dag_id="perf-automation-roas-etl",
...
daily_feedback_snapshot = utils.create_emr_spark_job(
    "DailyFeedbackSignals", "job.DailyFeedbackSignals", KONGMING_JAR, spark_options_list, job_setting_list + [
        ("OutOfSampleAttributeSetGenerator.AttributionLookBack", "30"),
    ], roas_etl_cluster, timedelta(hours=1)
)

daily_attr_events = utils.create_emr_spark_job(
    "DailyAttributedEvents", "job.DailyAttributedEvents", KONGMING_JAR, spark_options_list,
    job_setting_list + [("OutOfSampleAttributeSetGenerator.AttributionLookBack", "30")], roas_etl_cluster
)
...
generate_train_set_task = utils.create_emr_spark_job(
    "GenerateTrainSetRevenueLastTouch", "job.GenerateTrainSetRevenueLastTouch", KONGMING_JAR, spark_options_list + [
        ("packages", "com.linkedin.sparktfrecord:spark-tfrecord_2.12:0.4.0"),
    ], job_setting_list + [("addBidRequestId", "true"), ("trainSetPartitionCount", "500"), ("valSetPartitionCount", "100")],
...
generate_train_set_click_task = utils.create_emr_spark_job(
    "GenerateTrainSetRevenueClick", "job.GenerateTrainSetClick", KONGMING_JAR, spark_options_list + [
        ("packages", "com.linkedin.sparktfrecord:spark-tfrecord_2.12:0.4.0"),
    ], job_setting_list + [("addBidRequestId", "true")], roas_etl_cluster, timedelta(hours=6)
)
