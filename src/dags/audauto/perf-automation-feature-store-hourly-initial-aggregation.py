...
spark_options = [("executor-memory", "76g"), ("executor-cores", "10"), ("conf", "spark.driver.memory=76g"),
                 ("conf", "spark.driver.memoryOverhead=3788m"), ("conf", "spark.driver.cores=6"),
                 ("conf", "spark.driver.maxResultSize=76g"), ("conf", "spark.executor.memoryOverhead=3788m"),
                 ...
                 ("conf", "spark.sql.legacy.parquet.int96RebaseModeInRead=CORRECTED"), ("conf", "spark.default.parallelism=%s" % 7660),
                 ("conf", "spark.sql.shuffle.partitions=%s" % 5000)]
...
data_sensor = DatasetCheckSensor(
    dag=dag,
    task_id="contextualwithbid_available",
    poke_interval=60 * 10,
    timeout=60 * 60 * 6,
