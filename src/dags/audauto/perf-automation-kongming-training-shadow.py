...
promote_model_to_staging = False
...
kongming_training_dag = TtdDag(
    dag_id="perf-automation-kongming-training-shadow",
...
def get_training_commands():
    return [
        ...
        f"instance.experiment={experiment_name}",
...
def get_calibration_commands():
    return [
        ...
        f"--ttd_NeoCalibrationIsotonicRegressionLookupUserDataDataset_experimentName={experiment_name}",
        f"--ttd_CalibrationLogDataset_experimentName={experiment_name}",
        f"--ttd_NeoModelAvgPredDataset_experimentName={experiment_name}",
        f"--ttd_ScoredSampledImpressionForIsotonicRegDataset_experimentName={experiment_name}",
        f"--ttd_OfflineScoredImpressionDataset_experimentName={experiment_name}",
...
pytorch_stack_model = utils.create_docker_job(
    ...
    exec_args=[
        "train_set=full_kongming_two_stage_userdata", "instance=emr_kongming", f"instance.env={environment}",
        f"instance.model_creation_date={model_date}", f"train_set.base_model_date={base_model_date_template}",
        f"instance.experiment={experiment_name}", "instance.bias_path=./advertiser_bias.parquet"
    ],
...
pytorch_scoring_sampled = utils.create_docker_job(
    ...
    exec_args=get_scoring_commands() + [
        ...
        "+calibration_set.auxiliary_fields='{AdGroupIdStr:AdGroupId,CampaignIdStr:CampaignId,Weight:Weight,Target:Target}'",
    ],
...
pytorch_scoring_last_day = utils.create_docker_job(
    ...
    exec_args=get_scoring_commands() + [
        ...
        "+calibration_set.auxiliary_fields='{AdGroupIdStr:AdGroupId,CampaignIdStr:CampaignId}'",
    ],
...
calibration_task_in = utils.create_pyspark_docker_job(
    ...
    exec_args=get_calibration_commands() + [
        ...
        f"--promote_to_rollout={promote_model_to_staging}",
    ],
    emr=calibration_cluster,
)
