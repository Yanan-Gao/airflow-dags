...
docker_install_script = "s3://thetradedesk-mlplatform-us-east-1/libs/audience/packages/audience-models/prod/latest/install_docker_gpu_new_with_ray.sh"
...
previous_calibration_prediction_step = setup_prediction_step(
    common_step_kwargs, "PreviousCalibrationSPrediction", measurement_common_argument_list + previous_calibration_job_arguments
)
current_calibration_prediciton_step = setup_prediction_step(
    common_step_kwargs, "CurrentCalibrationSPrediction", measurement_common_argument_list + current_calibration_job_arguments
)
