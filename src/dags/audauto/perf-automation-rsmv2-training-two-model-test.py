...
test_exp_name = "/test_IdExtensionTest"
sensitive = "sensitive"
...
rsm_training_dag = TtdDag(
    dag_id="perf-automation-rsmv2-training-two-model-test",
...
rsmv2_br_model_success_file = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
...
rsmv2_seed_embedding_success_file = DateGeneratedDataset(
    bucket="thetradedesk-mlplatform-us-east-1",
    path_prefix="configdata/prod/audience",
    data_name="embedding/RSMV2/v=1",
    date_format="%Y%m%d000000",
    version=None,
    env_aware=False,
    success_file="_SUCCESS"
...
prod_model_file_sensor = OpTask(
    op=DatasetCheckSensor(
        task_id="control_model_file_found",
        datasets=[
            rsmv2_br_model_success_file,
            rsmv2_seed_embedding_success_file,
        ],
        ds_date="{{data_interval_start.to_datetime_string()}}",
        poke_interval=60 * 5,
        timeout=60 * 60 * 23,
...
policy_test_s3_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/test/audience/policyTable/RSM/v=1/{date_str}"
...
full_train_start_date = 20250525
...
sensitive_argument_list = [
    f"--env={override_env}", "--model_type=RSMV2", f"--exp_name={test_exp_name}", "--model_output_type=full_model_sensitive"
]
non_sensitive_argument_list = [
    f"--env={override_env}", "--model_type=RSMV2", "--sensitive=nonsensitive", f"--exp_name={test_exp_name}",
    "--model_output_type=full_model_nonsensitive"
]
...
# tmp solution to use v1 path
update_embedding_v1_success_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        task_id="update_embedding_v1_success_file_task",
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding/RSM{test_exp_name}/v=1/{date_str}/_SUCCESS",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_embedding_success_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding/RSMV2{test_exp_name}/v=1/{date_str}/_SUCCESS",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
# tmp solution to use v1 path
update_embedding_v1_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        task_id="update_embedding_v1_current_file_task",
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding/RSM{test_exp_name}/v=1/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
#         s3_bucket="thetradedesk-mlplatform-us-east-1",
#         s3_key=f"configdata/{override_env}/audience/policyTable/RSM{test_exp_name}/v=1/_CURRENT",
#         date=date_str,
#         append_file=True,
#         dag=adag,
#     )
...
update_embedding_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding/RSMV2{test_exp_name}/v=1/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_sensitive_tmp_embedding_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding_temp/RSMV2{test_exp_name}/{sensitive}/v=1/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_non_sensitive_tmp_embedding_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"configdata/{override_env}/audience/embedding_temp/RSMV2{test_exp_name}/{non_sensitive}/v=1/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_v1_model_success_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        task_id="update_v1_model_success_file_task",
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSM{test_exp_name}/bidrequest_model/{date_str}/_SUCCESS",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_model_success_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/bidrequest_model/{date_str}/_SUCCESS",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
# tmp solution to use v1 path
update_v1_model_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        task_id="update_v1_model_current_file_task",
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSM{test_exp_name}/bidrequest_model/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_model_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/bidrequest_model/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_full_model_sensitive_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/full_model_sensitive/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_full_model_non_sensitive_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/full_model_nonsensitive/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_br_model_sensitive_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/bidrequest_model_sensitive/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_br_model_nonsensitive_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/bidrequest_model_nonsensitive/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
update_full_model_current_file_task = OpTask(
    op=WriteDateToS3FileOperator(
        ...
        s3_bucket="thetradedesk-mlplatform-us-east-1",
        s3_key=f"models/{override_env}/RSMV2{test_exp_name}/full_model/_CURRENT",
        date=date_str,
        append_file=True,
        dag=adag,
    )
...
embedding_version_cloud_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/test/audience/embedding/RSMV2{test_exp_name}/v=1/_CURRENT"
...
bootstrap_script_actions = [
    ...
    ScriptBootstrapAction(
        "s3://thetradedesk-mlplatform-us-east-1/libs/audience/scripts/audience-models/prod/latest/tensorflow_init.sh", []
    ),
]
...
# for test
previous_feature_path_origin = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{override_env}/audience/schema/RSMV2/v=1/{previous_version}/features.json"
previous_feature_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{override_env}/audience/schema/RSMV2/v=1/{previous_version}/features_json"
current_feature_path_origin = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{override_env}/audience/schema/RSMV2/v=1/{date_str}/features.json"
original_br_feature_path_origin = f"s3://thetradedesk-mlplatform-us-east-1/models/{override_env}/RSMV2{test_exp_name}/bidrequest_model_{sensitive}/{date_str}/features.json"
current_br_feature_path_origin = f"s3://thetradedesk-mlplatform-us-east-1/models/{override_env}/RSMV2{test_exp_name}/bidrequest_model/{date_str}/features.json"

current_feature_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{env}/audience/schema/RSMV2/v=1/{date_str}/features_json"
# todo to change here to adopt new path
calibration_data_path = f"s3://thetradedesk-mlplatform-us-east-1/data/{override_env}/audience/RSMV2/Seed_None/v=1/{date_str}/mixedForward=Calibration/"
population_data_path = f"s3://thetradedesk-mlplatform-us-east-1/data/{override_env}/audience/RSMV2/Seed_None/v=1/{date_str}/split=Population/"
previous_model_path = f"s3://thetradedesk-mlplatform-us-east-1/models/{override_env}/RSMV2{test_exp_name}/full_two_output_model/{previous_version}"
current_model_path = f"s3://thetradedesk-mlplatform-us-east-1/models/{override_env}/RSMV2{test_exp_name}/full_two_output_model/{date_str}"
previous_calibration_output_path = f"s3://thetradedesk-mlplatform-us-east-1/data/{override_env}/audience/RSMV2{test_exp_name}/prediction/calibration_data/v=1/model_version={previous_version}/{date_str}"
current_calibration_output_path = f"s3://thetradedesk-mlplatform-us-east-1/data/{override_env}/audience/RSMV2{test_exp_name}/prediction/calibration_data/v=1/model_version={date_str}/{date_str}"
population_output_path = f"s3://thetradedesk-mlplatform-us-east-1/data/{override_env}/audience/RSMV2{test_exp_name}/prediction/population_data/v=1/model_version={date_str}/{date_str}"
...
v2_embedding_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/prod/audience/embedding/RSMV2/v=1/{date_str}/"
v1_embedding_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/prod/audience/embedding/RSM/v=1/{date_str}/"
...
copy_current_br_feature_json = OpTask(
    op=PythonOperator(
        task_id="copy_current_br_feature_json",
        provide_context=True,
        python_callable=copy_s3_object,
        op_kwargs={
            'source': original_br_feature_path_origin,
            'destination': current_br_feature_path_origin,
        },
        dag=adag
    )
)

copy_policy_table = OpTask(
    op=PythonOperator(
        task_id="copy_policytable",
        provide_context=True,
        python_callable=copy_s3_dir,
        op_kwargs={
            'source': policy_s3_path,
            'destination': policy_test_s3_path,
        },
        dag=adag
    )
)
...
previous_test_calibration_job_arguments = [
    f"--feature_path={previous_feature_path}", f"--data_path={calibration_data_path}", f"--model_path={previous_model_path}",
    f"--out_path={previous_calibration_output_path}"
]
current_test_calibration_job_arguments = [
    f"--feature_path={current_feature_path}", f"--data_path={calibration_data_path}", f"--model_path={current_model_path}",
    f"--out_path={current_calibration_output_path}"
]
population_test_job_arguments = [
    f"--feature_path={current_feature_path}", f"--data_path={population_data_path}", f"--model_path={current_model_path}",
...
audience_embedding_merge_step = EmrJobTask(
    ...
    eldorado_config_option_pairs_list=[
        ...
        ('tmpSenEmbeddingDataS3Path', f'configdata/{override_env}/audience/embedding_temp/RSMV2{test_exp_name}/{sensitive}/v=1'),
        ('tmpNonSenEmbeddingDataS3Path', f'configdata/{override_env}/audience/embedding_temp/RSMV2{test_exp_name}/{non_sensitive}/v=1'),
        ('embeddingDataS3Path', f'configdata/{override_env}/audience/embedding/RSMV2{test_exp_name}/v=1'),
        ('inferenceDataS3Path', f'data/{override_env}/audience/RSMV2{test_exp_name}/prediction/'),
...
###############################################################################
# copy prod embedding to control
###############################################################################

# v2_embedding_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{override_env}/audience/embedding/RSMV2/v=1/{date_str}/"
# v1_embedding_path = f"s3://thetradedesk-mlplatform-us-east-1/configdata/{override_env}/audience/embedding/RSM/v=1/{date_str}/"
#
# embedding_transfer_task = OpTask(
#     op=PythonOperator(
#         task_id="transfer-embedding-dataset",
#         python_callable=copy_s3_dir,
#         provide_context=True,
#         op_kwargs={
#             'source': v2_embedding_path,
#             'destination': v1_embedding_path
#         },
#         dag=adag
#     )
# )
...
# v1_br_model_path = f"s3://thetradedesk-mlplatform-us-east-1/models/{override_env}/RSM/bidrequest_model/{date_str}/"
#
# br_model_transfer_task = OpTask(
#     op=PythonOperator(
#         task_id="transfer-br-model-dataset",
#         python_callable=copy_s3_dir,
#         provide_context=True,
#         op_kwargs={
#             'source': v2_br_model_path,
#             'destination': v1_br_model_path
#         },
#         dag=adag
#     )
# )
...
#     promote_model_task = mlflow_operator.get_register_operator(model_name='RSM',test_name="RSM-test_IdExtensionControl",stage="staging",
#         tags={
#             RSMConfig.POLICY_TABLE_PATH_TAG_NAME: policy_key,
#             RSMConfig.SEED_EMBEDDING_PATH_TAG_NAME: v2_embedding_key,
#             RSMConfig.BID_REQUEST_MODEL_PATH_TAG_NAME: v2_br_model_path
...
# Flow
rsm_training_dag >> etl_file_sensor >> copy_policy_table >> rsm_training_non_sensitive_cluster_task
rsm_training_dag >> etl_file_sensor >> copy_policy_table >> rsm_training_sensitive_cluster_task

[
    rsm_training_non_sensitive_cluster_task, rsm_training_sensitive_cluster_task
] >> copy_current_br_feature_json >> update_full_model_non_sensitive_current_file_task >> update_full_model_sensitive_current_file_task >> update_full_model_current_file_task >> update_br_model_sensitive_current_file_task >> update_br_model_nonsensitive_current_file_task >> model_merge_task >> calibration_data_sensor

calibration_data_sensor >> update_previous_version
...
(
    audience_embedding_merge_cluster_task >> rsm_registry_cluster_task >> update_embedding_success_file_task >>
    update_embedding_v1_success_file_task >> update_embedding_current_file_task >> update_embedding_v1_current_file_task >>
    update_sensitive_tmp_embedding_current_file_task >> update_non_sensitive_tmp_embedding_current_file_task >> init_commit_files >>
    policy_commit_file_sensor >> emb_commit_file_sensor >> delay_task >> update_model_success_file_task >> update_v1_model_success_file_task
    >> update_model_current_file_task >> update_v1_model_current_file_task >> final_dag_status_step
)
