...
dag_name = "budget-hourly-cpm-controller-metrics"
...
vertica_budget_sensor = OpTask(
    op=DatasetCheckSensor(
        ...
        datasets=[
            production_adgroup_budget_dataset.with_check_type("hour"),
...
cpm_controller_metrics_task = DatabricksWorkflow(
    job_name="hourly_cpm_controller_metrics_job",
    cluster_name="hourly_cpm_controller_metrics_cluster",
    cluster_tags={
        "Team": "DIST",
    ...
    tasks=[
        S3PythonDatabricksTask(
            ...
            job_name="hourly_cpm_controller_metrics",
            whl_paths=[WHL_PATH],
        ),
    ],
