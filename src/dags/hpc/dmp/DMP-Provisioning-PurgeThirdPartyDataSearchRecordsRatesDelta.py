...
# purge job that cleans up and deletes old ThirdPartyDataSearchRecordsRatesDelta batches
dag_id = 'DMP-Provisioning-PurgeThirdPartyDataSearchRecordsRatesDeltaV3'
task_id = 'DMP_Provisioning_PurgeThirdPartyDataSearchRecordsRatesDeltaV3'  # DAG of one task
...
sql = "exec dmp.prc_PurgeThirdPartyDataSearchRecordsRatesDeltaV3 @keepDays = 2"
