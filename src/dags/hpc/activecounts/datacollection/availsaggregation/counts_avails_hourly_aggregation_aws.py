...
core_instance_types = [
    ...
    M6g.m6g_16xlarge().with_fleet_weighted_capacity(16)
]
...
avail_hourly_aggregation_cluster = EmrClusterTask(
    ...
    core_fleet_instance_type_configs=EmrFleetInstanceTypes(instance_types=core_instance_types, on_demand_weighted_capacity=64),
