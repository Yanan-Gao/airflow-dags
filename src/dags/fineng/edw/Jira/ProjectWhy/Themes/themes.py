    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # Log progress
                logging.info(f"Processed {total_processed} themes so far...")
                ...
                logging.error(f"Error in fetching themes data: {e}")
                continue

        logging.info(f"Total themes processed: {total_processed}")

    except Exception as e:
        logging.error(f"Error in get_themes {e}")
        raise e
