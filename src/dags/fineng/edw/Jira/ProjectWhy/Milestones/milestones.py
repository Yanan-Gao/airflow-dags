    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # Log progress
                logging.info(f"Processed {total_processed} milestones so far...")
                ...
                logging.error(f"Error in fetching milestones data: {e}")
                continue

        logging.info(f"Total milestones processed: {total_processed}")

    except Exception as e:
        logging.error(f"Error in get_milestones {e}")
        raise e
