...
vector_value_class_name = "com.thetradedesk.etlforecastjobs.preprocessing.columnstore.provisioningexport.GenerateZipIntMappings"
vector_value_generation_step_name = "generate-zip-mappings"
cluster_name = "uf_columnstore_generate_zip_mappings"
...
dag_name = "uf-columnstore-zip-mapping-dag"
job_start_date = datetime(year=2024, month=4, day=1, hour=6, minute=0)
