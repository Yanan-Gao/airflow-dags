...
mark_clickhouse_data_ready = columnstore_sql_functions.mark_dataset_loaded(
    run_date, [xd_level for xd_level in XdLevel], TableType.ClickHouseVectorValueMappings, isClickHouse=True
)
...
dag >> emr_cluster >> loading_chain_of_tasks >> mark_clickhouse_data_ready
