...
vector_value_class_name = "com.thetradedesk.etlforecastjobs.preprocessing.columnstore.provisioningexport.GenerateMarketPlaceIntMappings"
vector_value_generation_step_name = "generate-marketplace-mappings"
cluster_name = "uf_columnstore_generate_marketplace_mappings"
...
dag_name = "uf-columnstore-marketplace-mapping-dag"
job_start_date = datetime(year=2025, month=2, day=25, hour=6, minute=0)
