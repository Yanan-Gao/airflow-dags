...
_NAME = "StageXDeviceTargetingDataTable"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.StageXDeviceTargetingDataTable"
...
class StageXDeviceTargetingDataTable(EmrJobTask):
