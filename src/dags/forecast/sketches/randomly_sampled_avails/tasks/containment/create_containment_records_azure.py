...
from dags.forecast.sketches.randomly_sampled_avails.constants import GLOBAL_SPARK_OPTIONS_LIST_AZURE, \
    GLOBAL_JVM_SETTINGS_LIST_AZURE, AZURE_JAR_PATH, RAM_GENERATION_TIMESTAMP_KEY
...
_NAME = "CreateContainmentRecordsAzure"
_CLASS_NAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.containment.CreateContainmentRecordsAzure"
_SPARK_ADDITIONAL_OPTIONS: List[Any] = []
...
class CreateContainmentRecordsAzure(HDIJobTask):
