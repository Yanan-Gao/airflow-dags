...
_NAME = "FilterContainmentSamples"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.containment.FilterContainmentSamples"
...
class FilterContainmentSamples(EmrJobTask):
