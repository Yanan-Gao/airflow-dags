...
_NAME = "CreateContainmentRecords"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.containment.CreateContainmentRecords"
...
class CreateContainmentRecords(EmrJobTask):
