...
_NAME = "WeeklyFeedbackContainmentRecords"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.WeeklyFeedbackContainment"
...
class WeeklyFeedbackContainmentRecords(EmrJobTask):
