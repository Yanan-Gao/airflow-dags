...
_NAME = "WeeklyPointerRecords"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.WeeklyPointerRecords"
...
class WeeklyPointerRecords(EmrJobTask):
