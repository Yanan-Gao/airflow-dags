from dags.forecast.sketches.randomly_sampled_avails.constants import EMR_CLUSTER_SUFFIX, EMR_6_VERSION, \
    STANDARD_CLUSTER_TAGS, STANDARD_MASTER_FLEET_INSTANCE_TYPE_CONFIGS, CLUSTER_ADDITIONAL_PROPERTIES
from dags.forecast.sketches.randomly_sampled_avails.utils import get_core_fleet_instance_type_configs
from ttd.eldorado.aws.emr_cluster_task import EmrClusterTask

_NAME = "WeeklyProcessingCluster"
_ON_DEMAND_WEIGHT = 3200
_TAGS = {"Process": "WeeklyProcessing"}


class WeeklyProcessingCluster(EmrClusterTask):
