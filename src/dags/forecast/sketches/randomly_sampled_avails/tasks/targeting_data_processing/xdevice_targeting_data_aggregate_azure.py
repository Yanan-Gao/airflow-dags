...
_NAME = "XDeviceTargetingDataAggregateAzure"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.dataelementshmh.XDeviceTargetingDataAggregateAzure"
...
_JVM_CONFIG_OPTIONS = [
    ...
    ("dataElementsHmhCoalescePartitions", "100"),
...
class XDeviceTargetingDataAggregateAzure(HDIJobTask):
