...
_NAME = "run_task_append_xdevice_targeting_data_ram_daily_vectors_from_azure_to_s3"
_PARTITIONING_ARGS = {
    ...
    "vector_name": PartitioningArg(key="vectorName", value="XDeviceTargetingDataId", weight=2)
}
_dataset = get_test_or_default_value(RamDatasources.ram_daily_vectors_test, RamDatasources.ram_daily_vectors)


class AppendXDeviceTargetingDataRamDailyVectors(DatasetTransferTask):
