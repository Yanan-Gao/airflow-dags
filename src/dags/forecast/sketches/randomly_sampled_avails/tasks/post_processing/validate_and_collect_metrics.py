...
_NAME = "ValidateAndCollectDataMetrics"
_CLASSNAME = "com.thetradedesk.etlforecastjobs.universalforecasting.ram.ValidateAndCollectDataMetrics"
_SPARK_ADDITIONAL_OPTIONS = [("executor-memory", "27000M"), ("executor-cores", "4"),
                             ...
                             ('conf', 'fs.s3a.attempts.maximum=20'), ('conf', 'spark.sql.shuffle.partitions=6000')]
...
class ValidateAndCollectDataMetrics(EmrJobTask):
