...
iqbf_experiment_measurement = EmrJobTask(
    name="iqbfExperimentMeasurement",
    class_name="com.thetradedesk.jobs.iqbfexperiment.IQBFExperiment",
    executable_path=IQBF_EXPERIMENT_JAR,
    additional_args_option_pairs_list=spark_options_list,
    eldorado_config_option_pairs_list=[("runTime", RUNTIME_DATE), ("date", JOB_DATE)]
)

cluster.add_parallel_body_task(iqbf_experiment_measurement)

platform_level_iqbf_experiment_measurement = EmrJobTask(
    name="platformLevelIQBFExperimentMeasurement",
    class_name="com.thetradedesk.jobs.iqbfexperiment.PlatformLevelIQBFExperiment",
    executable_path=IQBF_EXPERIMENT_JAR,
    additional_args_option_pairs_list=spark_options_list,
    eldorado_config_option_pairs_list=[("runTime", RUNTIME_DATE), ("date", JOB_DATE)]
)

cluster.add_parallel_body_task(platform_level_iqbf_experiment_measurement)
...
iqbf_experiment_reportAgg >> iqbf_experiment_measurement
iqbf_experiment_reportAgg >> platform_level_iqbf_experiment_measurement
