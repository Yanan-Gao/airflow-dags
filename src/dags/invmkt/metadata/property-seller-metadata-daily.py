...
# Prod variables
job_name = 'property-seller-metadata-generation'
cluster_name = "invmkt_property_seller_metadata"
invmkt = INVENTORY_MARKETPLACE().team
emr_release_label = AwsEmrVersions.AWS_EMR_SPARK_3_5
job_schedule_interval = timedelta(days=1)
job_start_date = datetime(2025, 6, 15, 1)
...
dag: TtdDag = TtdDag(
    ...
    tags=[invmkt.jira_team, 'property-seller-metadata-aggregates'],
    default_args={
...
property_seller_metadata_cluster_task = EmrClusterTask(
    name=cluster_name,
...
config_list = [('date', run_date), ('datasetGenerationType', 'PropertySellerMetadataGeneration')]
...
job_step = EmrJobTask(
    ...
    cluster_specs=property_seller_metadata_cluster_task.cluster_specs
)

property_seller_metadata_cluster_task.add_sequential_body_task(job_step)
...
dag >> property_seller_metadata_cluster_task
wait_complete >> property_seller_metadata_cluster_task.first_airflow_op()
