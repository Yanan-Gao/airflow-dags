...
# Prod variables
job_name = 'MIST-avails-aggregates-generation-daily'
cluster_name = "invmkt_marketplace_mist_avails_agg_daily"
...
class_name = 'jobs.marketplaceinfoscaletool.MistAvailsAggregation'
...
mist_avails_agg_cluster_task = EmrClusterTask(
    name=cluster_name,
...
config_list = [('date', run_date), ('sampleRate', 0.1)]
...
job_step = EmrJobTask(
    ...
    cluster_specs=mist_avails_agg_cluster_task.cluster_specs
)

mist_avails_agg_cluster_task.add_sequential_body_task(job_step)
...
dag >> mist_avails_agg_cluster_task
wait_complete >> mist_avails_agg_cluster_task.first_airflow_op()
