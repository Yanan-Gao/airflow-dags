...
class Executables:
    ...
    identity_repo_executable_azure = "abfs://ttd-build-artefacts@ttdartefacts.dfs.core.windows.net/identity/release/com/thetradedesk/idnt/identity_2.12/latest/identity-assembly.jar"
