...
class AvailsMonitoring:
    ...
    def __get_avails_data_metrics_cluster(self):
        # TODO this has a prod issue with spark 3.5, see here: https://thetradedesk.atlassian.net/browse/IDNT-5393
        cluster = IdentityClusters.get_cluster(
            "AvailsDataMetricsCluster",
            self.dag,
            3500,
            ComputeType.MEMORY,
        ...
        cluster.add_parallel_body_task(
            IdentityClusters.task(
                "com.thetradedesk.idnt.identity.metrics.executivedashboard.AvailsDataMetrics",
                timeout_hours=10,
        ...
        cluster.add_parallel_body_task(
            IdentityClusters.task(
                "com.thetradedesk.idnt.identity.metrics.executivedashboard.ImpressionDataMetrics",
                timeout_hours=3,
                action_on_failure="CONTINUE",
                executable_path=Executables.identity_repo_executable_spark_3_3,
            )
