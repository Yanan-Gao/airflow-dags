...
cluster = IdentityClusters.get_cluster("LogEtlCluster", dag, 1200, ComputeType.STORAGE, use_delta=False)
...
dag >> cluster >> OpTask(op=FinalDagStatusCheckOperator(dag=dag.airflow_dag))
