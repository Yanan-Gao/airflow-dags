...
DEAL_CHANNEL_AVAIL_MATCH_INVENTORY_RECOMMENDATIONS_BATCH_TYPE_ID = 5
...
MONGODB_SECRET_KEY = 'madeup-string'
...
version_id = f"{{{{ task_instance.xcom_pull(task_ids='{CREATE_VERSION_TASK_ID}', key='{VERSION_ID_KEY}') }}}}" if env == TtdEnvFactory.prod else "0"
