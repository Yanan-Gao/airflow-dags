...
DICT_CONFIG = {
    "test": {
        ...
        "s3_folder": "dev/adam.sugarman/application/audienceExpansion",
        "application_data_url": f"s3://{s3_bucket}/dev/adam.sugarman/application/audienceExpansion/data",
        "job_flow_role": "DataPipelineDefaultResourceRole"
    },
    "prod": {
        "version": f"{version}",
        "s3_folder": "application/audienceExpansion",
...
group_id = "com.thetradedesk.audienceExpansion"
...
cxtCategoryAggResultUrl = "s3://ttd-contextual/prod/parquet/aggregated_requested_urls_8day/v=1"
...
def verify_daily_ingestion_success_fn(referenceDate, **kwargs):
    ...
    url_key = "/".join([
        "backstage", "30d", f"env={env}", "system=audienceExpansion", "restricted-site", f"Date={referenceDate}", "_SUCCESS"
    ])
...
add__ingest_unsampled_avails = add_emr_spark_step(
    ...
    spark_args=["spark.jars.packages=io.delta:delta-core_2.12:2.4.0"],
    driver_core_count=avails_ingestion_driver_core_count,
    driver_memory="150G",
    executor_count=avails_ingestion_executor_count,
    executor_core_count=avails_ingestion_executor_core_count,
    ...
    spark_jars=[
        "s3://ttd-datprd-us-east-1/application/segment/bin/com.thetradedesk.segment.client-spark_3/2.15.2/com.thetradedesk.segment.client-spark_3-2.15.2-all.jar",
    ],
    cluster_specs=create_avails_ingestion_cluster.cluster_specs,
...
add__ingest_cxt_category_results = add_emr_spark_step(
    ...
    command_args=[
        ...
        "--lookBackDays", "3", "--referenceDate", referenceDate, "--cxtCategoryResultsUrl", cxtCategoryAggResultUrl,
...
add__ingest_precomputed_relevant_site_data = add_emr_spark_step(
    ...
    artifact_id="ingestion",
    command_args=[
        "ingest-precomputed-relevant-site",
        "--env",
        "prod",
        "--logLevel",
        log_level,
        "--applicationDataUrl",
        f"s3://{s3_bucket}/application/audienceExpansion/data",
        "--referenceDateTime",
        referenceDateTime,
        "--ttdDataSupportPiiPreformattedDataUrl",
        ttdDataSupportPiiUrl + "/precomputedSites",
        "--prometheusPushGatewayAddress",
        prometheus_push_gateway_address,
        "--backstageUrl",
        application_data_url,
...
add__ingest_data_support_s3_configs = add_emr_spark_step(
    ...
    artifact_id="ingestion",
    command_args=[
        "ingest-data-support-configuration",
        "--env",
        "prod",
        "--logLevel",
        log_level,
        ...
        verticaDbUrl,
        "--verticaDbUser",
        "@/home/hadoop/.ttd/audience_extension/VERTICA_DB_USER",
        "--verticaDbPassword",
        "@/home/hadoop/.ttd/audience_extension/VERTICA_DB_PASS",
        "--ttdDataSupportPiiPreformattedDataUrl",
        ttdDataSupportPiiUrl + "/preformattedSeedsV2",
        "--prometheusPushGatewayAddress",
        prometheus_push_gateway_address,
        "--backstageUrl",
        application_data_url,
        ...
        provisioningDomain,
        "--provisioningDbUser",
        "@/home/hadoop/.ttd/audience_extension/PROVISIONING_DB_USER",
        "--provisioningDbPassword",
        "@/home/hadoop/.ttd/audience_extension/PROVISIONING_DB_PASS",
    ],
    utilizeMaximizeResourceAllocation=True,
    cluster_specs=create_small_ingestion_cluster.cluster_specs
)
...
add__ingest_partner_s3_metadata = add_emr_spark_step(
    ...
    command_args=[
        ...
        "--provisioningDbPassword",
        "@/home/hadoop/.ttd/audience_extension/PROVISIONING_DB_PASS",
        "--providerDataImportUrl",
        providerDataImportUrl,
        "--contextualLookBackDays",
        "3",
        "--appSharedResourceUrl",
        sharedResourceUrl,
        "--prometheusPushGatewayAddress",
        prometheus_push_gateway_address,
        "--dentsuTaxonomyAdoptionTimestamp",
        "2025-03-19",
        "--backstageUrl",
        application_data_url,
    ],
...
add__batch_extension_stages = add_emr_spark_step(
    ...
    command_args=[
        ...
        "--prometheusPushGatewayAddress", prometheus_push_gateway_address, "--mediumCountryBatchSizeFactor", "4",
        "--smallCountryBatchSizeFactor", "8"
    ],
    utilizeMaximizeResourceAllocation=True,
    cluster_specs=create_staging_ingestion_cluster.cluster_specs
)
...
add__ingest_dmp_data_segment_service = add_emr_spark_step(
    ...
    artifact_id="ingestion",
    command_args=[
        "ingest-dmp-data-segment-service",
        "--env",
        "prod",
        "--logLevel",
        log_level,
...
add__extension_extend_seed_data = add_emr_spark_step(
    ...
    command_args=[
        ...
        referenceDateTime, "--lalImpressionDays", availsUnsampledLookBackDays, "--lalMaxSiteRank", "2000", "--xdLookBackDays",
        ...
        "--prometheusPushGatewayAddress", prometheus_push_gateway_address, "--lalNonActiveMaxSiteRank", "2000"
    ],
    utilizeMaximizeResourceAllocation=True,
    cluster_specs=create_extension_cluster.cluster_specs,
...
add__publishing_partner_s3_metadata = add_emr_spark_step(
    ...
    command_args=[
        ...
        "--providerDataImportUrl",
        providerDataImportUrl,
        "--publishingLookBackDays",
        impressionLookBackDays,
        "--prometheusPushGatewayAddress",
        prometheus_push_gateway_address,
        "--applicationDataUrl",
        f"s3://{s3_bucket}/application/audienceExpansion/data",
